...
# # rds settings
# #quero que DB_HOST = aws_db_instance.database_lambda.address seja o rds_host
# rds_host  = "database-lambda.cqjxqjxqjxqj.us-east-1.rds.amazonaws.com"
...
#     # Upload file to S3
#     bucket_name = 'project-terraform-s3-sqs-demo-bucket'
#     file_name = '/tmp/database.txt'
